...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-center max-w-xs sm:max-w-md md:max-w-lg lg:max-w-full mx-auto'>
            <motion.header
                className={`fixed top-0 z-50  bg-white shadow-md mx-auto transition-all duration-300 p-3 py-4 ${widthFull ? "w-full my-0 p-5" : "w-full lg:w-[70rem] my-5  rounded-3xl backdrop-blur-3xl bg-transparent "}`}
