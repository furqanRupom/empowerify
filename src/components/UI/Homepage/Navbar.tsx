            ...
            >
                <div className="container mx-auto flex justify-between  items-center  max-w-5xl ">
                    ...
                    <div className="hidden md:flex items-center space-x-5">
                        <Link className='text-gray-800 hover:text-emerald-500' href="/">How it Works</Link>
                        <button className="text-gray-800 hover:text-emerald-500">Sign Up</button>
                        <button className={` px-4 py-2    border border-emerald-500 rounded-3xl ${widthFull ? 'bg-emerald-500 text-white hover:bg-white hover:text-emerald-500 duration-500' : 'text-emerald-500 bg-white hover:bg-emerald-500 duration-500 hover:text-white'}`}>Start Funding</button>
                    </div>
                    <button className="md:hidden text-3xl text-emerald-400" onClick={toggleMenu}>
                ...
                {isOpen && (
                    <div className={`md:hidden  flex flex-col items-center py-4 space-y-4 ${widthFull ? 'bg-white' : 'backdrop-blur-2xl'}`}>
                        ...
                        <Link href="#" className="text-gray-800 hover:text-emerald-400">About</Link>
                        <Link href="#" className="text-gray-800 hover:text-emerald-400">Contact</Link>
                        <button className="text-gray-800 hover:text-emerald-400">Sign Up</button>
                        <button className="bg-emerald-400 text-white px-4 py-2  hover:bg-emerald-500 rounded-3xl">Start Funding</button>
                    </div>
                )}
            </motion.header>
        </div>
