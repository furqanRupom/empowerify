              ...
              <div className="md:w-2/3 w-full px-4  flex flex-col">
                  ...
                  <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                      ...
                      <div className="w-44 pt-6 md:pt-0">
                          <a className="bg-orange-500 text-white font-semibold justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
                              Contact US
                          </a>
                      </div>
                  </div>
                  <div className="flex flex-col">
                      <div className="flex mt-24 flex-row justify-between items-center">
                          ...
                          <a className="hidden md:block cursor-pointer text-gray-600 hover:text-gray-500 uppercase">
                              About
                          </a>
                          <a className="hidden md:block cursor-pointer text-gray-600 hover:text-gray-500 uppercase">
                              Services
